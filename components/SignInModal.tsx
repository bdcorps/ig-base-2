...
export default function SignInModal({ open, onClose, callbackURL = "/" }: Props) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-sm rounded-2xl border border-neutral-200 bg-white p-8 shadow-xl"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="mb-6 text-center">
          <h2 className="text-lg font-semibold text-neutral-900">Sign in to continue</h2>
          <p className="mt-1 text-[13px] text-neutral-500">
            Log in with Google to generate your carousel.
          </p>
        </div>
