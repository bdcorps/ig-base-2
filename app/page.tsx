      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 p-6 lg:grid-cols-[1fr_440px_300px]">
        <section className="flex flex-col gap-4">
          <div className="flex items-center justify-between gap-4">
            <h1 className="text-2xl font-bold">Carousel Design Agent</h1>
          ...
          <button
            ...
            className="rounded-lg bg-neutral-900 px-4 py-2.5 text-base font-semibold text-white disabled:opacity-50"
          >
          ...
          {showJson && design && (
            <pre className="max-h-80 overflow-auto rounded-lg border border-neutral-200 bg-white p-3 text-xs leading-tight text-neutral-600">
        ...
        <section className="flex flex-col items-center gap-3">
          <h2 className="self-start text-base font-semibold text-neutral-600">Canvas</h2>
          {design ? (
            <SlideRenderer
              design={design}
              theme={theme}
            ...
            <div
              className="flex items-center justify-center rounded-lg border border-dashed border-neutral-300 text-base text-neutral-500"
        ...
        <section className="flex flex-col gap-6">
          ...
          <div>
            <h2 className="mb-3 text-base font-semibold text-neutral-600">Theme</h2>
  ...
  const num = (label: string, value: number, key: string) => (
    <label className="flex items-center justify-between gap-2">
      ...
      <input
        ...
        className="w-20 rounded border border-neutral-200 bg-white px-2 py-1.5 text-sm"
      />
    </label>
  );

  return (
    <div className="rounded-lg border border-neutral-200 bg-white p-4 text-base">
      <div className="mb-2 flex items-center justify-between">
        <h2 className="font-semibold capitalize text-neutral-800">{element.kind} element</h2>
      ...
      <div className="flex flex-col gap-2">
        ...
        {element.kind === "text" && (
          <>
            ...
            <label className="flex items-center justify-between gap-2">
              <span className="text-neutral-600">Align</span>
              <select
                value={element.align}
                onChange={(e) => onChange({ align: e.target.value as "left" | "center" | "right" })}
                className="w-24 rounded border border-neutral-200 bg-white px-2 py-1.5 text-sm"
              >
